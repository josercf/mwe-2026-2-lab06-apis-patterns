# Lab 06 - Adapter, Decorator e Strategy em APIs Node.js e Python
...
> Aula 06 - Design Patterns Estruturais e Comportamentais | 08/09/2026

---

## Missao

Integrar a LogiTech a uma API legada de rastreamento usando Adapter, expondo uma API moderna em FastAPI e em Express/TypeScript.
...
```bash
git clone https://github.com/josercf/mwe-2026-2-lab06-apis-patterns.git
cd mwe-2026-2-lab06-apis-patterns
code .
...
Portas expostas pelo ambiente: 8000, 3000
...
```
mwe-2026-2-lab06-apis-patterns/
├── .devcontainer/
...
| | |
|---|---|
| Slides desta aula | <https://josercf.github.io/FIAP-2026-2-3SI/aulas-1sem/aulas/aula06.html> |
